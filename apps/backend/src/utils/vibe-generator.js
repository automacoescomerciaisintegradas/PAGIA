...
export async function generateVibeProject(options) {
    ...
    if (!existsSync(join(vibeDir, 'src')))
        mkdirSync(join(vibeDir, 'src'), { recursive: true });
...
//# sourceMappingURL=vibe-generator.js.map