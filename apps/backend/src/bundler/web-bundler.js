...
{{/each}}
     ...
     */
    loadTemplate(platform, filePath) {
     ...
     */
    async bundleByIds(agentIds, platform, options = {}) {
        const agents = [];
     ...
     */
    formatAgentContent(agent, options) {
        let content = '';
        // Descrição
     ...
     */
    async export(bundle, outputPath) {
     ...
     */
    async exportWithMetadata(bundle, outputPath) {
        ensureDir(dirname(outputPath));
...
//# sourceMappingURL=web-bundler.js.map