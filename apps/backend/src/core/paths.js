 ...
 */
export function getGlobalConfigYamlPath() {
    return join(getGlobalConfigDir(), 'config.yaml');
}
/**
 * Get all global directory paths
 */
export function getGlobalDirectoryStructure() {
    return {
 ...
 */
export function ensureGlobalDirectories() {
 ...
 */
export function getProjectDirectoryStructure(projectRoot) {
 ...
 */
export function getWorkspaceHash(projectRoot) {
 ...
 */
export function getWorkspaceStoragePath(projectRoot) {
 ...
 */
export function isInPagiaProject(projectRoot) {
 ...
 */
export function findNearestPagiaDir(startDir) {
