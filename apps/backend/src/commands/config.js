...
configCommand
    ...
    const answers = await inquirer.prompt([
        ...
        },
        {
            type: 'input',
            name: 'apiKey',
            message: (ans) => `API Key do ${ans.type}:`,
            when: (ans) => ans.type !== 'ollama',
        ...
        },
        {
            ...
            name: 'model',
            message: 'Modelo:',
            choices: (ans) => getModelChoices(ans.type),
        ...
        },
        {
            ...
            validate: (input) => input >= 0 && input <= 2 ? true : 'Valor deve estar entre 0 e 2',
        },
        {
            type: 'number',
            name: 'maxTokens',
...
function getModelChoices(provider) {
    switch (provider) {
        case 'gemini':
            return [
