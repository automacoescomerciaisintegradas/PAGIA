...
import { terminalService, TerminalInfo } from '../services/terminal-service.js';
 ...
 */
async function listSupportedTerminals(): Promise<void> {
 ...
 */
async function detectCurrentTerminal(): Promise<void> {
 ...
 */
async function interactiveSetup(options: any): Promise<void> {
 ...
 */
async function configureTerminal(terminal: string, options: any): Promise<void> {
    const configOptions: any = {};
 ...
 */
function showThemePreview(): void {
