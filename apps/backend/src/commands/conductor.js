...
conductorCommand
    ...
    logger.box(`${chalk.bold('🎭 Conductor - Context-Driven Development')}\n\n` +
        ...
        '• workflow.md - Processos de trabalho', { title: '🎼 Setup', borderColor: 'magenta' });
...
conductorCommand
    ...
    const conductorPath = configManager.isInitialized()
        ...
        : '.conductor';
    conductorAgent.setConductorPath(conductorPath);
    logger.box('Modo interativo com o Conductor.\n' +
        'Digite suas perguntas ou comandos.\n' +
        'Use "sair" para encerrar.', { title: '🎭 Conductor Chat', borderColor: 'magenta' });
    while (true) {
