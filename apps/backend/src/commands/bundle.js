...
import { webBundler } from '../bundler/web-bundler.js';
...
bundleCommand
    ...
    try {
        ...
        // Salvar
        const outputPath = options.output || join(configManager.getPagiaFolder(), 'bundles', `${bundle.platform}-${Date.now()}.md`);
