...
export class ModuleCreationMasterAgent extends BaseAgent {
    name = 'Module Creation Master';
    role = 'Especialista em Arquitetura de Módulos';
    description = 'Agente especializado em criação, edição e validação de módulos BMAD completos com melhores práticas. Especializado em criar módulos coesos, escaláveis e que entregam funcionalidade completa.';
    module = 'bmb';
    capabilities = [
...
//# sourceMappingURL=module-creation-master-agent.js.map