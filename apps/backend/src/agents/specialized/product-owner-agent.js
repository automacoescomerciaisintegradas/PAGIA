...
export class ProductOwnerAgent extends BaseAgent {
    ...
    description = 'Agente especializado em gerenciamento de produto, levantamento de requisitos, criação de PRDs, user stories e priorização de backlog. Traduz necessidades de negócio em especificações técnicas.';
    module = 'core';
    capabilities = [
...
//# sourceMappingURL=product-owner-agent.js.map