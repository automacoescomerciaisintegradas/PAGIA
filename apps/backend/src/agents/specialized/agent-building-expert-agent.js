...
export class AgentBuildingExpertAgent extends BaseAgent {
    ...
    description = 'Agente especializado em criação, edição e validação de agentes BMAD com melhores práticas. Especializado em criar agentes robustos, mantíveis e em conformidade com os padrões BMAD Core.';
    module = 'bmb';
    capabilities = [
...
//# sourceMappingURL=agent-building-expert-agent.js.map