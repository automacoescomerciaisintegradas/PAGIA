...
export class AnalystAgent extends BaseAgent {
    ...
    description = 'Agente especializado em análise de mercado, pesquisa competitiva, análise de tendências e ideação de projetos. Gera briefs de projeto, documentos de análise de mercado e pesquisa competitiva.';
    module = 'core';
    capabilities = [
