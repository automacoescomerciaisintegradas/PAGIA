...
export class PlannerAgent extends BaseAgent {
    ...
    role = 'Especialista em planejamento e gestão de projetos';
    description = 'Cria planos de ação detalhados, decompõe tarefas e gerencia cronogramas';
    module = 'core';
    capabilities = [
...
- Organize hierarquicamente
  `;
    ...
    parseOptions(input) {
        ...
        return {
            type: context.type || this.defaultOptions.type,
            format: context.format || this.defaultOptions.format,
     ...
     */
    buildPlanPrompt(requirement, options) {
        return `
...
Use formato hierárquico com checklists.
     ...
     */
    buildDecomposePrompt(feature, options) {
        return `
...
Use formato de checklist markdown.
     ...
     */
    buildEstimatePrompt(tasks, options) {
        return `
...
| Tarefa | Otimista | Provável | Pessimista | PERT |
     ...
     */
    buildRisksPrompt(project, options) {
        return `
...
Forneça uma matriz de riscos visual.
     ...
     * Prompt para roadmap
     */
    buildRoadmapPrompt(project, options) {
        return `
...
Inclua descrição de cada item do roadmap.
     ...
     */
    buildSprintPrompt(backlog, options) {
        return `
...
Use formato estruturado com checklists quando apropriado.
     ...
     */
    async createPlan(requirement, type = 'global', format = 'markdown') {
        return this.execute({
