...
export class ArchitectAgent extends BaseAgent {
    ...
    description = 'Agente especializado em arquitetura de software, design de sistemas, escolha de tecnologias e documentação técnica. Cria ADRs, diagramas de arquitetura e define padrões técnicos.';
    module = 'core';
    capabilities = [
