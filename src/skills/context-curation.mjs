...
// Simple implementation of context curation functionality in JavaScript
...
// Export the class
export { ContextCuration };

// If running directly, execute a test
...
if (process.argv[1] === __filename) {
  async function test() {
    ...
    console.log('Building context tree...');
